...
import serverSideTokenValidationFirebase from '../assets/projectSectionImages/serverSideTokenValidationFirebase.png';
import googleLogin from '../assets/projectSectionImages/googleLogin.png';
import authContextWithPersistence from '../assets/projectSectionImages/authContextWithPersistence.png';
import stylingGoogleButton from '../assets/projectSectionImages/stylingGoogleButton.png';
...
const projectsData = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        images: [
          {
            url: stylingGoogleButton,
            alt: 'Styling Sign in with Google button'
          },
        ],
      },
      {
      ...
      },
      {
        id: 7,
        title: 'Auth',
        text: 'For Authentication and Authorization I used Firebase with Email/Password and Google sign in methods. Once logged in, the user is stored in browser local storage to persist through page refreshes. I also created a Profile feature where the user can change their username and email. The token obtained from Firebase is sent in the requests to the server in the Authorization header and verified server side with the Firebase Admin SDK.',
        tag: 'Auth',
        images: [
          {
            url: googleLogin,
            alt: 'Handling log in with Google provider using Firebase Authentication'
          },
          {
            url: authContextWithPersistence,
            alt: 'Auth context with user persistence in local storage'
          },
          {
            url: serverSideTokenValidationFirebase,
            alt: 'Handling Firebase Authentication server side'
          },
        ],
      },
    ],
